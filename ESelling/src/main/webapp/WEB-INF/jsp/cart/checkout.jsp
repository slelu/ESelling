	...
	<div class="clear">
		<div style="float: left;">
			<fieldset>
				...
				<table>
					<tr>
						<td><label for="shippingAddress.street"
								class="error">
								<spring:message code="address.street" />
							</label></td>
						<td><form:input id="shippingAddress.street" path="shippingAddress.street" /></td>
						<td><form:errors path="shippingAddress.street" /></td>
					</tr>
					<tr>
						<td><label for="shippingAddress.state"
								class="error">
								<spring:message code="address.state" />
							</label></td>
						<td><form:input id="shippingAddress.state" path="shippingAddress.state" /></td>
						<td><form:errors path="shippingAddress.state" /></td>
					</tr>
					<tr>
						<td><label for="shippingAddress.zipcode"
								class="error">
								<spring:message code="address.zipcode" />
							</label></td>
						<td><form:input id="shippingAddress.zipcode" path="shippingAddress.zipcode" /></td>
		...
		<fieldset>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<b><td colspan="2" align="right"><spring:message
									code="order.total" /></b>
						</td>
